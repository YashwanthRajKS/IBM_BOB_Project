...
| **Report** | Full Word document (`YashwanthRajKS_AmazonRatingPrediction_Report.docx`) — 10 sections, embedded images |
...
│
├── YashwanthRajKS_AmazonRatingPrediction.py        # Single-file submission combining train, backend & UI
└── YashwanthRajKS_AmazonRatingPrediction_Report.docx  # Full project report (cover → conclusion, ~15 pages)
```
...
| `YashwanthRajKS_AmazonRatingPrediction.py` | Python | Combined single-file submission file containing model training, Flask API, and Streamlit UI |
| `YashwanthRajKS_AmazonRatingPrediction_Report.docx` | Word | 10-section project report — abstract through conclusion |
...
- Saves: `YashwanthRajKS_AmazonRatingPrediction_Report.docx`
...
**File:** `YashwanthRajKS_AmazonRatingPrediction_Report.docx`  
...
| # | Section | Contents |
|---|---|---|
| 1 | Cover page | Title, author (Yashwanth Raj KS), date, course name |
